  ...
  public static void testMembers() throws Exception {
    assertMembers(
        new String[][] {
          {
            "class C {",
            "  /* (FieldInfo static final /C.X : int) */",
            "  static final int X;",
            "  /* (FieldInfo private /C.x : int) */",
            "  private int x;",
            "  /* (CallableInfo private static /C.<clinit>(1) @ ()V : void) */",
            "  static{ X = 42; }",
            "  /* (CallableInfo /C.<init>(1) @ ()V : void) */",
            "  C() { x = X; }",
            "  /* (CallableInfo /C.<init>(2) @ (Ljava/lang/String;)V : void) */",
            "  C(String s) { x = X; }",
            "  /* (CallableInfo /C.<init>(3) @ ([Ljava/lang/Integer;)V : void) */",
            "  C(Integer... is) { x = X; }",
            "  /* (CallableInfo /C.f(1) @ (Ljava/lang/Integer;)I : int) */",
